...
def app(_epoch, _clauses, _t, _s, _dataset, _data_dim, _machine_type, _window_x, _window_y,
    ...
    def init(_epoch_results):
        if _machine_type == "TM":
            TM.init(os, _clauses, _t, _s, _name, _machine_type, _data_dim, _dataset, app_start_date, _epoch, _boost,
                    Settings[11], _epoch_results)
        elif _machine_type == "cTM":
            CTM.init(os, _clauses, _t, _s, _window_x, _window_y, _shape_x, _shape_y, _shape_z, _name, _machine_type,
                     _data_dim, _dataset, app_start_date, _epoch, _boost, Settings[11], _epoch_results)
